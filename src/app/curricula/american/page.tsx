    ...
    <div className="min-h-screen">
          ...
          <div className="relative">
            <div className="bg-navy rounded-2xl overflow-hidden aspect-video flex items-center justify-center group cursor-pointer relative">
              ...
              <div className="relative text-center z-10">
                ...
                <div className="text-white font-bold text-sm mb-1">American Curriculum Overview</div>
      ...
      <section className="py-14 px-6 bg-white border-t border-gray-100">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-xl font-black text-navy tracking-tight mb-6">Common questions from American curriculum schools</h2>
