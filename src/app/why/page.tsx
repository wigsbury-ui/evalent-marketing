...
const BENEFITS = [
  ...
  { href: '/why/operational-benefits', title: 'Operational Benefits', desc: 'Run admissions through summer holidays and beyond. Automated scoring, remote oversight, and no staffing dependencies.', icon: '⚙️' },
