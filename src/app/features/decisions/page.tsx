...
export default function Page() {
  ...
  const faqs = [
    ['Does the assessor need to log in to record a decision?', 'No. The report email contains four decision buttons: Admit, Admit with Support, Waitlist, and Do Not Admit. One click records the decision without any portal login.'],
    ['What if the assessor does not respond?', 'A follow-up reminder is sent automatically after 48 hours. The dashboard flags unactioned reports and school admins can reassign the decision to another assessor at any time.'],
    ['Can a decision be changed after it is recorded?', 'Yes. School admin users can amend decisions from the dashboard. Both the original and amended decision are recorded in the audit log with timestamps and attribution.'],
    ['Is every decision permanently recorded for compliance?', 'Yes. Every decision is timestamped, attributed to the assessor, and stored in a tamper-proof audit log. This is exportable and can be retained for as long as your school requires.'],
    ['Can notes be added to an applicant record?', 'Yes. Free-text notes can be added to any applicant record from the dashboard and stored alongside the decision in the audit log.'],
  ]
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="py-14 px-6 bg-white border-t border-gray-100">
        <div className="max-w-3xl mx-auto">
          ...
          </div>lButton from '@/components/HeroTrialButton'
import Nav from '@/components/Nav'
import Footer from '@/components/Footer'
import DecisionsDemo from '@/components/features/DecisionsDemo'
import Link from 'next/link'
