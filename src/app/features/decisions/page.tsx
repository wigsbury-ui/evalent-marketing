...
export default function Page() {
  ...
  const faqs: [string, string][] = [
    ...
    ['Is every decision permanently recorded for compliance?', 'Yes. Every decision is timestamped, attributed to the assessor, and stored in a tamper-proof audit log. This is exportable and retained for as long as your school requires.'],
