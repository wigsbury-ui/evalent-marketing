    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="bg-navy py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-blue-300 text-xs font-bold tracking-widest px-4 py-1.5 rounded-full mb-5">FEATURE 9 OF 9</div>
      ...
      <VimeoEmbed videoId="1183289724" title="Evalent | Team Management" />
