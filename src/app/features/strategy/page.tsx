...
export default function Page() {
  ...
  const faqs = [
    ['Does the Strategy page cover all grades including Early Years?', 'Yes. The enrolment planning table covers every grade from Pre-K to Grade 12. Grades assessed via Evalent have their Accepted and In Process figures auto-populated. All other data is entered manually by your team.'],
    ['Where does the enrolment data come from?', 'Your admissions team enters current enrolment, targets, leavers, and returning students directly into the planning table. Evalent auto-populates pipeline data for assessed grades.'],
    ['How do the Evalent strategic signals work?', 'Evalent analyses your grade data and generates 3 to 5 signals classified into Enrolment and Capacity, Retention, and Pipeline. Each recommends a concrete next action and regenerates each time you click Generate.'],
    ['Can I filter the view by grade group?', 'Yes. Filter pills let you switch between Whole School, Early Years and Primary, Senior School, or any individual grade. All KPI cards, signals, and the chart update instantly.'],
    ['Is the Strategy page included in the free trial?', 'Yes. The full Strategy page including all six KPI cards, Evalent signals, and the executive report generator is available during the 10-report free trial with no credit card required.'],
  ]onst strategyFaqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question", "name": "What is the Evalent Strategy page?", "acceptedAnswer": {"@type": "Answer", "text": "The Strategy page gives principals and senior leadership a live picture of every grade's enrolment position, with six KPI cards, Evalent-generated signals, an enrolment planning table, and a one-click executive report generator ready for board packs."}},
