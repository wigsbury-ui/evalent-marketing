...
export default function Page() {
  const faqs: [string, string][] = [
    ['Does the student need to create an account?', 'No. Students access their assessment via a secure personal link sent to their email. No account, password, or app download is required.'],
    ['How is the assessment link delivered?', 'The moment you register a student, Evalent automatically generates a personalised link and emails it directly with instructions. No manual steps required.'],
    ['What if the student has not completed after the first day?', 'Evalent sends an automatic reminder if the student has not started. The dashboard flags outstanding links and you can resend manually at any time from the admin panel.'],
    ['Can I register multiple students at once?', 'Individual registration takes under 60 seconds per student. Bulk import is on the development roadmap for future releases.'],
    ['How is student data protected?', 'All data is stored in secure encrypted infrastructure. Student data is never used to train language models and is governed under UAE Federal Data Protection Law with GDPR alignment.'],
  ]
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="bg-navy py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-blue-300 text-xs font-bold tracking-widest px-4 py-1.5 rounded-full mb-5">FEATURE 1 OF 9</div>
      ...
      <VimeoEmbed videoId="1175794469" title="Evalent | Student Registration" />
