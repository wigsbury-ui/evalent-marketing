...
export default function Page() {
  ...
  const faqs = [
    ...
    ['How is the assessment link delivered to the student?', 'The moment you register a student, Evalent automatically generates a personalised link and emails it directly with instructions. No manual steps required.'],
